// Windows hotkey implementation placeholder
// Will use SetWindowsHookEx for global hotkey monitoring
...
void HotkeyManager::start() { spdlog::warn("Windows hotkey not yet implemented"); }
