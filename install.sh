...
# Copy daemon management scripts
...
echo ""
echo "Quick Start (run as your user, NOT with sudo):"
echo "  cd /opt/autowhisper"
echo "  ./scripts/setup-daemon.sh     # Set up and start the daemon"
echo ""
echo "Or use make targets:"
echo "  make daemon-setup             # Set up and start"
echo "  make daemon-restart           # Restart after config changes"
echo "  make daemon-status            # Check status and recent logs"
echo "  make daemon-logs              # Follow live logs"
echo ""
echo "Manual commands:"
echo "  systemctl --user start autowhisper"
echo "  systemctl --user stop autowhisper"
echo "  systemctl --user status autowhisper"
echo "  journalctl --user -u autowhisper -f"
echo ""
echo "Or run manually (without daemon):"
echo "  cd /opt/autowhisper && source venv/bin/activate && python -m autowhisper -v"
echo ""
echo "Default hotkey: Shift+Super (hold to record, release to transcribe)"
